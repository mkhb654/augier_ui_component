...
const PaymentConfirmation = () => {
    ...
    const [showCapabilityStatement, setShowCapabilityStatement] = useState(false); // Start with false
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col">
            ...
            {/* Main Content */}
            <main className={`flex-grow flex flex-col items-center justify-center p-4 ${showCapabilityStatement ? 'opacity-50' : 'opacity-100'} transition-opacity duration-300`}>
